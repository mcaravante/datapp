...
#   docker build -f infra/docker/admin.Dockerfile -t datapp-admin .
# ---------------------------------------------------------------------
...
COPY --from=builder --chown=datapp:datapp /app/apps/admin/.next/standalone ./
COPY --from=builder --chown=datapp:datapp /app/apps/admin/.next/static ./apps/admin/.next/static
COPY --from=builder --chown=datapp:datapp /app/apps/admin/public ./apps/admin/public
